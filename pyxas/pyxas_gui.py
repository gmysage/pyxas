...
class App(QWidget):
    ...
    def layout_fit2d(self):
        ...
        lb_sep = QLabel()
        lb_sep.setFixedHeight(2)
        lb_sep.setFixedWidth(300)
        lb_sep.setStyleSheet('background-color: rgb(50, 50, 100);')
        ...
        vbox_edge_integ = self.layout_edge_integral()
        ...
        vbox_assemble.addWidget(lb_empty3)
        vbox_assemble.addWidget(lb_sep)
        vbox_assemble.addWidget(lb_empty4)
        vbox_assemble.addLayout(vbox_edge_integ)
    ...
    def layout_edge_integral(self):
        lb_edge_integ = QLabel()
        lb_edge_integ.setText('Edge integral')
        lb_edge_integ.setFont(self.font1)
        lb_edge_integ.setFixedWidth(250)

        lb_edge_integ_note = QLabel()
        lb_edge_integ_note.setText('Find edge position using integral method')
        lb_edge_integ_note.setFont(self.font2)
        lb_edge_integ_note.setFixedWidth(350)

        ######### energy range
        lb_edge_integ_s = QLabel()
        lb_edge_integ_s.setText('Energy range       start:')
        lb_edge_integ_s.setFont(self.font2)
        lb_edge_integ_s.setFixedWidth(160)

        lb_edge_integ_e = QLabel()
        lb_edge_integ_e.setText(' end:')
        lb_edge_integ_e.setFont(self.font2)
        lb_edge_integ_e.setFixedWidth(40)

        self.tx_edge_integ_s = QLineEdit()
        self.tx_edge_integ_s.setFont(self.font2)
        self.tx_edge_integ_s.setFixedWidth(60)

        self.tx_edge_integ_e = QLineEdit()
        self.tx_edge_integ_e.setFont(self.font2)
        self.tx_edge_integ_e.setFixedWidth(60)

        hbox_edge_integ_range = QHBoxLayout()
        hbox_edge_integ_range.addWidget(lb_edge_integ_s)
        hbox_edge_integ_range.addWidget(self.tx_edge_integ_s)
        hbox_edge_integ_range.addWidget(lb_edge_integ_e)
        hbox_edge_integ_range.addWidget(self.tx_edge_integ_e)
        hbox_edge_integ_range.setAlignment(QtCore.Qt.AlignLeft)

        ############# fit roi
        self.pb_edge_integ_roi = QPushButton('Fit ROI')
        self.pb_edge_integ_roi.setFont(self.font2)
        self.pb_edge_integ_roi.clicked.connect(self.fit_edge_integ_roi)
        self.pb_edge_integ_roi.setEnabled(True)
        self.pb_edge_integ_roi.setFixedWidth(105)

        lb_edge_integ_roi = QLabel()
        lb_edge_integ_roi.setFont(self.font2)
        lb_edge_integ_roi.setText(' ROI #: ')
        lb_edge_integ_roi.setFixedWidth(50)

        self.tx_edge_integ_roi = QLineEdit(self)
        self.tx_edge_integ_roi.setFont(self.font2)
        self.tx_edge_integ_roi.setText('-1')
        self.tx_edge_integ_roi.setFixedWidth(60)

        hbox_edge_roi_plot = QHBoxLayout()
        hbox_edge_roi_plot.addWidget(self.pb_edge_integ_roi)
        hbox_edge_roi_plot.addWidget(lb_edge_integ_roi)
        hbox_edge_roi_plot.addWidget(self.tx_edge_integ_roi)
        hbox_edge_roi_plot.setAlignment(QtCore.Qt.AlignTop)

        ####### fit 2D image
        self.pb_edge_integ_2d = QPushButton('Fit 2D edge')
        self.pb_edge_integ_2d.setFont(self.font2)
        self.pb_edge_integ_2d.clicked.connect(self.fit_edge_integ_2D)
        self.pb_edge_integ_2d.setEnabled(True)
        self.pb_edge_integ_2d.setFixedWidth(105)

        #######
        vbox = QVBoxLayout()
        vbox.addWidget(lb_edge_integ)
        vbox.addWidget(lb_edge_integ_note)
        vbox.addLayout(hbox_edge_integ_range)
        vbox.addLayout(hbox_edge_roi_plot)
        vbox.addWidget(self.pb_edge_integ_2d)
        vbox.setAlignment(QtCore.Qt.AlignTop)
        return vbox
    ...
    def layout_multi_elem_2D(self):
        ...
        lb_multi_eng.setText('Fit composition')
        ...
        self.pb_multi_elem_fit = QPushButton('Fit composition')
        ...
        self.pb_multi_elem_save.clicked.connect(self.save_multi_elem_concentration)
        ...
        layout_multi_elem_convert_thick = self.layout_multi_elem_convert_thick()
        ...
        vbox_multi_elem.addLayout(layout_multi_elem_convert_thick)
    ...
    def layout_multi_elem_batch(self):
        ...
        lb_file = QLabel()
        lb_file.setText('Image path:')
        lb_file.setFixedWidth(75)
        lb_file.setFont(self.font2)

        self.tx_multi_elem_folder = QLineEdit()
        self.tx_multi_elem_folder.setFixedWidth(225)
        ...
        lb_eng_file = QLabel()
        lb_eng_file.setText('XEng path:')
        lb_eng_file.setFixedWidth(75)
        lb_eng_file.setFont(self.font2)

        self.tx_multi_elem_eng_folder = QLineEdit()
        self.tx_multi_elem_eng_folder.setFixedWidth(225)
        self.tx_multi_elem_eng_folder.setFont(self.font2)

        self.pb_mulit_elem_eng_open = QPushButton('Open')
        self.pb_mulit_elem_eng_open.setFont(self.font2)
        self.pb_mulit_elem_eng_open.setFixedWidth(80)
        self.pb_mulit_elem_eng_open.clicked.connect(self.open_file_multi_elem_eng)

        hbox_multi_elem_eng_open = QHBoxLayout()
        hbox_multi_elem_eng_open.addWidget(lb_eng_file)
        hbox_multi_elem_eng_open.addWidget(self.tx_multi_elem_eng_folder)
        hbox_multi_elem_eng_open.addWidget(self.pb_mulit_elem_eng_open)
        hbox_multi_elem_eng_open.setAlignment(QtCore.Qt.AlignLeft)
        ...
        vbox_multi_elem_batch.addLayout(hbox_multi_elem_eng_open)
    ...
    def layout_multi_elem_convert_thick(self):
        self.pb_multi_rho = QPushButton()
        self.pb_multi_rho.setText('To thickness')
        self.pb_multi_rho.setFont(self.font2)
        self.pb_multi_rho.setFixedWidth(120)
        self.pb_multi_rho.clicked.connect(self.convert_multi_elem_thickness)

        lb_multi_rho = QLabel()
        lb_multi_rho.setFont(self.font2)
        lb_multi_rho.setText('Compound density (g/cm3):')
        lb_multi_rho.setFixedWidth(180)

        self.tx_multi_rho = QLineEdit(self)
        self.tx_multi_rho.setFont(self.font2)
        self.tx_multi_rho.setText('1')
        self.tx_multi_rho.setValidator(QDoubleValidator())
        self.tx_multi_rho.setFixedWidth(60)

        hbox = QHBoxLayout()
        hbox.addWidget(self.pb_multi_rho)
        hbox.addWidget(lb_multi_rho)
        hbox.addWidget(self.tx_multi_rho)
        hbox.setAlignment(QtCore.Qt.AlignLeft)
        return hbox
    ...
    def layout_canvas(self):
        ...
        self.pb_adj_cmap = QPushButton('Auto')
        ...
        self.pb_adj_cmap.setFixedWidth(60)

        self.chkbox_fix_cmap = QCheckBox('fix')
        self.chkbox_fix_cmap.setFont(self.font2)
        self.chkbox_fix_cmap.setFixedWidth(50)
        self.chkbox_fix_cmap.setChecked(False)
        ...
        hbox_cmap.addWidget(self.chkbox_fix_cmap)
    ...
    def fit_multi_elem_thickness(self):
        try:
            ...
            self.multi_elem_concentration = res['concentration']
    ...
    def save_multi_elem_to_summary(self):
        img_concentration = self.smooth(self.multi_elem_concentration) * self.mask
        img_concentration[img_concentration<0] = 0
        img_err = self.multi_elem_fit_err * self.mask
        img_sum = np.sum(img_concentration, axis=0) * self.mask
        img_ratio = pyxas.rm_abnormal(img_concentration / img_sum) * self.mask

        if self.cb1.findText('Multi-elem fit (ratio)') < 0:
            self.cb1.addItem('Multi-elem fit (ratio)')
        if self.cb1.findText('Multi-elem fit (concentration: mol/cm2)') < 0:
            self.cb1.addItem('Multi-elem fit (concentration: mol/cm2)')
        ...
        self.data_summary['Multi-elem fit (concentration: mol/cm2)'] = img_concentration
        self.data_summary['Multi-elem fit error'] = img_err

    def save_multi_elem_concentration(self):
    ...
    def convert_multi_elem_thickness(self):
        rho_compound = float(self.tx_multi_rho.text())
        try:
            img_concentration = self.data_summary['Multi-elem fit (concentration: mol/cm2)']
            elem, _ = self._get_multi_elem()
            img_thick_um = pyxas.convert_concentration_to_thickness(elem, img_concentration, rho_compound)
            self.data_summary['Multi-elem fit (thickness: [um])'] = img_thick_um
            if self.cb1.findText('Multi-elem fit (thickness: [um])') < 0:
                self.cb1.addItem('Multi-elem fit (thickness: [um])')
                self.cb1.setCurrentText('Multi-elem fit (thickness: [um])')
        except Exception as err:
            print(err)


    def open_file_multi_elem_eng(self):
        #xanes_eng, img_xanes = pyxas.check_eng_image_order(xanes_eng, img_xanes)
        self.load_file_multi_elem_eng_batch_successfull = False
        try:
            options = QFileDialog.Option()
            options |= QFileDialog.DontUseNativeDialog
            file_type = 'txt files (*.txt)'
            fn, _ = QFileDialog.getOpenFileName(xanes, "QFileDialog.getOpenFileName()", "", file_type, options=options)
            if fn:
                self.tx_multi_elem_eng_folder.setText(fn)
        except:
            print('fail to load Energy file')
        ...
        try:
            ...
            if self.load_file_multi_elem_batch_successfull:
                ...
                for i in range(n):
                    ...
                    img = pyxas.rm_abnormal(img)
                    img_stack = img.copy()
                    self.xanes_eng = np.array(np.loadtxt(fn_eng))
                    self.xanes_eng, img_stack = pyxas.check_eng_image_order(self.xanes_eng, img_stack)
    ...
    def generate_smart_mask(self):
        try:
            ...
            self.cb1.setCurrentText('Smart Mask')  # this will call "update_canvas_img()"
    ...
    def _get_roi_selection(self, item):
        try:
            n = item.text()
            roi_selected = 'roi_' + n
    ...
    def plot_roi_fit_new(self, return_flag=0):
        try:
            ...
            elem = self._get_elem()
            roi_selected = self._get_roi_selection(self.tx_fit_roi)
            fit_eng_range = self._get_fit_eng_range()
    ...
    def fit_edge_integ_roi(self):
        try:
            roi_selected = self._get_roi_selection(self.tx_edge_integ_roi)
            img = self._select_xanes_fit_img()

            if len(img):
                img = self.smooth(img)
            eng = self.xanes_eng.copy()
            img_stack = self._get_roi_image(img, roi_selected)
            img_stack_s = np.mean(np.mean(img_stack, axis=-1), axis=-1)
            img_stack_s = img_stack_s.reshape((len(eng), 1, 1))
            m1 = np.min(img_stack_s)
            m2 = np.max(img_stack_s)
            try:
                E1 = float(self.tx_edge_integ_s.text())
                E2 = float(self.tx_edge_integ_e.text())
            except:
                print('check energy range')
                return 0
            edge = pyxas.edge_integral(img_stack_s, eng, E1, E2)
            edge = np.squeeze(edge)
            plt.figure()
            plt.plot(eng, img_stack_s.squeeze())
            plt.plot([edge, edge], [m1*0.98, m2*1.02])
            txt = f'E1={E1}, E2={E2}, edge={edge:2.5f}'
            plt.title(txt)
            plt.show()
        except Exception as err:
            print(err)
    ...
    def fit_edge_integ_2D(self):
        try:
            self.pb_edge_integ_2d.setEnabled(False)
            img = self._select_xanes_fit_img()
            if len(img):
                img = self.smooth(img)
            eng = self.xanes_eng.copy()
            try:
                ...
                print('check energy range')
                return 0
            edge = pyxas.edge_integral(img, eng, E1, E2)
            self.edge_integ = edge.copy()
            if self.cb1.findText('Edge integral') < 0:
                self.cb1.addItem('Edge integral')
            self.cb1.setCurrentText('Edge integral')
            self.update_canvas_img()
        except Exception as err:
            print(err)
            self.msg = str(err)
    ...
    def fit_edge_integ_3D(self):
        try:
            self.pb_3D_edge_integ.setEnabled(False)
            fn_eng = self.fn_eng_3D_peak_fit
            file_path = self.file_path
            file_type = self.file_type
            file_prefix = self.file_prefix
            hdf_attr = self.tx_param_hdf.text()
            file_save_edge_fit = f'{file_path}/edge_fit'
            pyxas.create_directory(file_save_edge_fit)
            try:
            ...
            mask_comp = self.fit_param['n_comp'] # cluster mask component
            binning = self.fit_param['binning']
            ...
            for i in range(n_file):
                ...
                s = img_xanes.shape
                if binning > 1:
                    output_size = (s[1]//binning, s[2]//binning)
                    img_xanes = pyxas.crop_scale_image(img_xanes, output_size)
                if filter_size > 1:
                    img_xanes = pyxas.img_smooth(img_xanes, filter_size, axis=0)

                edge = pyxas.edge_integral(img_xanes, xanes_eng, E1, E2)
                if mask_comp > 0:
                    mask, img_labels = pyxas.kmean_mask(img_xanes,  mask_comp)
                    mask = mask[0]
                    mask3D.append(mask.squeeze())
                else:
                    mask = 1
                edge = edge * mask
                fn_save_edge = f'{file_save_edge_fit}/{fn_save}_edge_pos.tiff'
                io.imsave(fn_save_edge, edge.astype(np.float32))
                edge3D.append(edge.squeeze())

            fn_save_edge_3D = f'{file_save_edge_fit}/edge_3D.tiff'
            fn_save_edge_3D_mask = f'{file_save_edge_fit}/mask_3D.tiff'
            io.imsave(fn_save_edge_3D, np.array(edge3D).astype(np.float32))
            if mask_comp > 0:
                io.imsave(fn_save_edge_3D_mask, np.array(mask3D).astype(np.float32))
            msg = 'Edge finding finished'
        except Exception as err:
            print(err)
            msg = str(err)
        finally:
            self.lb_3D_msg.setText(msg)
            self.pb_3D_edge_integ.setText('Fit edge integral')
            self.pb_3D_edge_integ.setEnabled(True)
            QApplication.processEvents()
    ...
    def convert_percentage_image(self):
        try:
            ...
            try:
                ...
                img = self.canvas1.current_img.copy()
    ...
    def fit_edge_curve(self):
        ...
        try:
            ...
            if self.fit_peak_method == 1: # spline
                ...
                res = pyxas.fit_peak_curve_poly(x, y, fit_order=k, num=10001)
                y_eval = res['matrix_Y'].flatten()
    ...
    def find_edge_peak_image(self):
        try:
            ...
            if self.chkbox_peak.isChecked():
                ...
                self.cb1.setCurrentText('XANES Peak Fit')
        ...
        try:
            ...
            if n_img != n_eng:
                ...
                for i in range(n_img):
                    ...
                    eng_comb[i] = self.get_comb_xanes_data(fn_eng, mode='eng')
    ...
    def xanes_img_smooth(self):
        ...
        canvas = self.canvas1
        img_stack = canvas.img_stack.copy()
        self.img_rm_noise = self.smooth(img_stack, axis=0)
        if self.cb1.findText('Noise removal') < 0:
            self.cb1.addItem('Noise removal')
        self.cb1.setCurrentText('Noise removal')
        self.update_canvas_img()
    ...
    def get_roi_average(self):
        try:
            ...
            roi_shape = img.shape
            mask_roi, mask_type = self.get_roi_mask(roi_list, roi_item, roi_shape)
            img = img * mask_roi
            '''
            roi_cord = np.int32(np.array(roi_list[roi_item.text()][:4]))
            a, b, c, d = roi_cord[0], roi_cord[1], roi_cord[2], roi_cord[3]
            ...
            print(txt)
            '''
            self.msg = (f'   {roi_item.text()}:    Mean value = {v_mean:2.6f},  '
                        f'Variation = {v_var:2.6f},   Min = {v_min:2.6f},   Max = {v_max:2.6f}')
            plt.figure()
            if n_point >= 1e4:
                bins = 100
            elif n_point >= 1e3:
                ...
                bins = 20
            plt.hist(img_f, bins=bins)
            plt.title(roi_item.text())
            plt.show()
            QApplication.processEvents()
        except Exception as err:
            self.msg = str(err)
            ...
            if fn:
                ...
                if self.rd_hdf.isChecked():  # read hdf file
                    ...
                    try:
                        ...
                        if (not type(self.xanes_eng) is list) and (not type(self.xanes_eng) is np.ndarray):
                            self.xanes_eng = [self.xanes_eng]
                    ...
                    try:
                        ...
                        st = '{0:2.4f}, {1:2.4f}, ..., {2:2.4f} keV (totally, {3} energies)'.format(
                            self.xanes_eng[0], self.xanes_eng[1], self.xanes_eng[-1], len(self.xanes_eng))
                ...
                if ref_index >= s[0]:  # sequantial align next image with its previous image
                    ...
                    for i in range(1, s[0]):
                        ...
                        if self.rd_ali1.isChecked():
                            ...
                            """
                            if method == 'rigid': # do another round of "translation"
                                rsft, csft, sr = pyxas.align_img_stackreg(prj[i - 1], img_ali[i], align_flag=0,method='translation')
                                img_ali[i] = sr.transform(img_ali[i])
                            """
                        elif self.rd_ali2.isChecked():
                    ...
                    for i in range(s[0]):
                        ...
                        if self.rd_ali1.isChecked():
                            ...
                            """
                            if method == 'rigid':
                                rsft, csft, sr = pyxas.align_img_stackreg(prj[ref_index], prj[i], align_flag=0, method='translation')
                                img_ali[i] = sr.transform(img_ali[i])
                            """
                        elif self.rd_ali2.isChecked():
    ...
    def set_contrast_for_canvas_img(self, canvas):
        n = len(canvas.img_stack)
        canvas.current_img_index = min(n-1, canvas.current_img_index)
        canvas.current_img = canvas.img_stack[canvas.current_img_index]
        cmin, cmax = self.get_contrast()
        canvas.cmin = cmin
        canvas.cmax = cmax
    ...
    def update_canvas_img(self):
        ...
        try:
            if type_index == 'Raw image':
                ...
                self.set_contrast_for_canvas_img(canvas)
                '''
                canvas.current_img_index = self.sl1.value()
                canvas.current_img = canvas.img_stack[canvas.current_img_index]
                cmin, cmax = self.get_contrast()
                ...
                slide.setMaximum(max(sh[0] - 1, 0))
                self.current_image = img[0]
                self.display_cmin_cmax(0, 1, canvas)
                #self.data_summary[type_index] = self.canvas1.img_stack * self.mask
            elif type_index == 'Multi-elem fit (concentration: mol/cm2)':
                self.img_colormix_raw = np.array([])
                canvas.rgb_flag = 0
                img =  self.data_summary['Multi-elem fit (concentration: mol/cm2)']
                self.pb_roi_draw.setEnabled(True)
                canvas.x, canvas.y = [], []
                canvas.axes.clear()  # this is important, to clear the current image before another imshow()
                sh = img.shape
                ...
                self.current_image = img[0]
                #self.auto_contrast(self.canvas1)
            elif type_index == 'Multi-elem fit (thickness: [um])':
                self.img_colormix_raw = np.array([])
                canvas.rgb_flag = 0
                img =  self.data_summary['Multi-elem fit (thickness: [um])']
                self.pb_roi_draw.setEnabled(True)
                canvas.x, canvas.y = [], []
                canvas.axes.clear()  # this is important, to clear the current image before another imshow()
                sh = img.shape
                ...
                canvas.rgb_flag = 1
                c1 = np.float32(self.tx_cmax.text())
                c2 = np.float32(self.tx_cmin.text())
                cmin = min(c1, c2)
                cmax = max(c2, c2)
                # img = (img - cmin) / (cmax - cmin)
                canvas.img_stack = img
    ...
    def get_contrast(self):
        try:
            if self.chkbox_fix_cmap.isChecked():
                c1 = np.float32(self.tx_cmax.text())
                c2 = np.float32(self.tx_cmin.text())
                cmin = min(c1, c2)
                cmax = max(c1, c2)
            else:
                cmin, cmax = self.canvas1.auto_contrast()
            self.display_cmin_cmax(cmin, cmax, self.canvas1)
        except Exception as err:
            self.msg = str(err)
            cmin, cmax = 0, 1
        finally:
    ...
    def vbox_3D_assemble_xanes(self):
        ...
        self.rd_3D_ali_method_rigid = QRadioButton('Rigid + Trans.')
        self.rd_3D_ali_method_rigid.setFixedWidth(120)
    ...
    def layout_3D_fitting_method(self):
        ...
        self.rd_param_fit_method2 = QRadioButton('NNLS (slow)')
        self.rd_param_fit_method2.setFixedWidth(120)
        self.rd_param_fit_method2.setFont(self.font2)
        self.rd_param_fit_method2.setChecked(False)
        ...
        hbox_fit_param_method.addWidget(self.rd_param_fit_method2)
    ...
    def layout_3D_fit_peak_only(self):
        ...
        lb_3D_edge_param = QLabel()
        lb_3D_edge_param.setText('Fit param:')
        lb_3D_edge_param.setFont(self.font1)
        lb_3D_edge_param.setFixedWidth(80)
        """
        lb_edge_smooth = QLabel()
        lb_edge_smooth.setText('smooth:')
        ...
        """
        lb_3D_edge_order = QLabel()
        lb_3D_edge_order.setText('order:')
        lb_3D_edge_order.setFixedWidth(50)
        lb_3D_edge_order.setFont(self.font2)

        self.tx_3D_edge_order = QLineEdit()
        self.tx_3D_edge_order.setText('4')
        ...
        lb_3D_filt = QLabel()
        lb_3D_filt.setFont(self.font2)
        lb_3D_filt.setText('      Median filter: ')
        lb_3D_filt.setFixedWidth(110)

        self.tx_3D_filt = QLineEdit(self)
        self.tx_3D_filt.setFont(self.font2)
        self.tx_3D_filt.setText('1')
        self.tx_3D_filt.setValidator(QIntValidator())
        self.tx_3D_filt.setFixedWidth(70)
        ...
        hbox_peak_param.addWidget(lb_3D_edge_param)
        hbox_peak_param.addWidget(lb_3D_edge_order)
        ...
        hbox_peak_param.addWidget(lb_3D_filt)
        hbox_peak_param.addWidget(self.tx_3D_filt)
        ...
        lb_space2 = QLabel()
        lb_space2.setFixedWidth(5)

        lb_3D_edge_integ = QLabel()
        lb_3D_edge_integ.setText('Fit edge:')
        lb_3D_edge_integ.setFixedWidth(80)
        lb_3D_edge_integ.setFont(self.font1)

        lb_3D_edge_integ_note = QLabel()
        lb_3D_edge_integ_note.setText('Check: if need alignment and apply cluster mask')
        lb_3D_edge_integ_note.setFixedWidth(360)
        lb_3D_edge_integ_note.setFont(self.font2)


        self.pb_3D_edge_integ = QPushButton()
        self.pb_3D_edge_integ.setText('Fit edge integral')
        self.pb_3D_edge_integ.setFont(self.font2)
        self.pb_3D_edge_integ.setFixedWidth(180)
        self.pb_3D_edge_integ.clicked.connect(self.fit_edge_integ_3D)

        lb_3D_edge_bin = QLabel('Binning:')
        lb_3D_edge_bin.setFont(self.font2)
        lb_3D_edge_bin.setEnabled(True)
        lb_3D_edge_bin.setFixedWidth(70)

        self.cb_3D_edge_bin = QComboBox()
        self.cb_3D_edge_bin.setFont(self.font2)
        self.cb_3D_edge_bin.addItem('1 x 1')
        self.cb_3D_edge_bin.addItem('2 x 2')
        self.cb_3D_edge_bin.addItem('4 x 4')
        self.cb_3D_edge_bin.setFixedWidth(70)

        """
        lb_3D_edge_filt = QLabel()
        lb_3D_edge_filt.setFont(self.font2)
        lb_3D_edge_filt.setText('  Median filter: ')
        lb_3D_edge_filt.setFixedWidth(110)

        self.tx_3D_edge_filt = QLineEdit(self)
        self.tx_3D_edge_filt.setFont(self.font2)
        self.tx_3D_edge_filt.setText('1')
        self.tx_3D_edge_filt.setValidator(QIntValidator())
        self.tx_3D_edge_filt.setFixedWidth(70)
        """
        hbox_edge = QHBoxLayout()
        hbox_edge.addWidget(lb_3D_edge_integ)
        hbox_edge.addWidget(lb_3D_edge_integ_note)
        hbox_edge.addWidget(lb_3D_edge_bin)
        hbox_edge.addWidget(self.cb_3D_edge_bin)
        hbox_edge.addWidget(lb_space)
        #hbox_edge.addWidget(lb_3D_edge_filt)
        #hbox_edge.addWidget(self.tx_3D_edge_filt)
        hbox_edge.addWidget(lb_space2)
        hbox_edge.addWidget(self.pb_3D_edge_integ)
        hbox_edge.setAlignment(QtCore.Qt.AlignLeft)
        ...
        vbox_3D_find_peak.addLayout(hbox_edge)
    ...
    def load_3D_energy(self):
        ...
        try:
            ...
            self.load_eng_successful = 1
            self.fn_eng_3D_peak_fit = fn
            if self.load_file_successful:
                e1 = np.min(self.eng)
                e2 = np.max(self.eng)
                self.tx_param_fit_range_s.setText(f'{e1:2.4f}')
                self.tx_param_fit_range_e.setText(f'{e2:2.4f}')
            else:
                print('fails to load energy')
                self.lb_3D_msg.setText('fails to load energy')
                return 0
            self.tx_3D_edge_s.setText(f'{e1:2.4f}')
            self.tx_3D_edge_e.setText(f'{e2:2.4f}')
            self.tx_param_fit_range_s.setText(f'{e1:2.4f}')
            self.tx_param_fit_range_e.setText(f'{e2:2.4f}')
        except Exception as err:
    ...
    def collect_3D_fit_param(self):
        ...
        try:
            ...
            ## for edge fitting only
            b = self.cb_3D_edge_bin.currentText()
            self.fit_param['binning'] = int(b[0])

            self.fit_param['filter_size'] = int(self.tx_3D_filt.text())
...
class MyCanvas(FigureCanvas):
    ...
    def auto_contrast(self):
        ...
        if len(non_zero) == 0:
            ...
            self.cmax = np.max(non_zero)
            self.cmin = np.min(non_zero)
        ...
        self.update_img_one(img_disp, self.current_img_index)
